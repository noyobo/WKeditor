...
gallery/WKeditor/1.1/plugin/WKfont/WKfont
gallery/WKeditor/1.1/index

*/
KISSY.add('gallery/WKeditor/1.1/plugin/WKfont/WKfont',function (S, Node,XTemplate) {
    var EMPTY = '';
    var $ = Node.all;
    /**
     *
...
KISSY.add('gallery/WKeditor/1.1/index',function(S, Node, XTemplate, WKfont) {
    var EMPTY = '';
    var $ = Node.all;
    /**
     * @class WKeditor
